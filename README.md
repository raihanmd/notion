...
- Ì¥ß **Backend** (`./backend`) ‚Äî built with [NestJS](https://nestjs.com/) and [Prisma ORM](https://www.prisma.io/)
- Ìºê **Frontend** (`./frontend`) ‚Äî built with [Next.js](https://nextjs.org/)
- ‚ö° Uses [Bun](https://bun.sh/) as the JavaScript runtime and package manager for both frontend and backend
